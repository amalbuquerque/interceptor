defmodule AnnotatedInterceptorOnErrorTest do
  use ExUnit.Case

  @process_name :annotated_on_error_test_process
  ...
  describe "module with a single function" do
    test "it intercepts the function after it errors" do
      ...
      assert_raise ArithmeticError, ~r/bad argument in arithmetic expression/, fn ->
        AnnotatedInterceptedOnError1.to_intercept()
      end
      ...
      assert intercepted_mfa == {AnnotatedInterceptedOnError1, :to_intercept, []}
    end
  end
  ...
  describe "module with two functions and other statement" do
    test "it intercepts the function on error" do
      ...
      assert_raise ArithmeticError, ~r/bad argument in arithmetic expression/, fn ->
        AnnotatedInterceptedOnError2.to_intercept()
      end
      ...
      assert %ArithmeticError{} == intercepted_error
      assert intercepted_mfa == {AnnotatedInterceptedOnError2, :to_intercept, []}
    end
    ...
    test "it also intercepts the other function" do
      ...
      assert_raise ArithmeticError, ~r/bad argument in arithmetic expression/, fn ->
        AnnotatedInterceptedOnError2.other_to_intercept()
      end
      ...
      assert length(callback_calls) == 1
      assert intercepted_mfa == {AnnotatedInterceptedOnError2, :other_to_intercept, []}
    end
  end
  ...
  describe "module with two functions and a private one" do
    test "it intercepts the function on error" do
      ...
      assert_raise ArithmeticError, ~r/bad argument in arithmetic expression/, fn ->
        AnnotatedInterceptedOnError3.other_to_intercept(4)
      end
      ...
      assert length(callback_calls) == 1
      assert intercepted_mfa == {AnnotatedInterceptedOnError3, :other_to_intercept, [4]}
    end
    ...
    test "it doesn't intercept the function that isn't configured" do
      ...
      assert_raise ArgumentError, ~r/argument error/, fn ->
        AnnotatedInterceptedOnError3.not_to_intercept()
      end
    ...
    test "it doesn't intercept the function that is outside of the intercept block" do
      ...
      assert_raise ArgumentError, ~r/argument error/, fn ->
        AnnotatedInterceptedOnError3.definitely_not_to_intercept()
      end
