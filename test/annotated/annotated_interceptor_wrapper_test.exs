defmodule AnnotatedInterceptorWrapperTest do
  use ExUnit.Case

  @process_name :annotated_wrapper_test_process

  describe "module with a single function" do
    test "it intercepts the function passing it as a lambda" do
      {:ok, _pid} = spawn_agent()

      result = AnnotatedInterceptedByWrapper1.to_intercept()
      ...
      assert intercepted_mfa == {AnnotatedInterceptedByWrapper1, :to_intercept, []}
    end
  end
  ...
  describe "module with two functions and other statement" do
    test "it intercepts the function passing it as a lambda" do
      ...
      result = AnnotatedInterceptedByWrapper2.to_intercept()
      ...
      assert intercepted_mfa == {AnnotatedInterceptedByWrapper2, :to_intercept, []}
    end

    test "it also intercepts the other function" do
      {:ok, _pid} = spawn_agent()

      result = AnnotatedInterceptedByWrapper2.other_to_intercept()
      ...
      assert result == callback_result
      assert result == "HELLO"
      assert intercepted_mfa == {AnnotatedInterceptedByWrapper2, :other_to_intercept, []}
    end
  end
  ...
  describe "module with two functions and a private one" do
    test "it intercepts the function" do
      ...
      result = AnnotatedInterceptedByWrapper3.other_to_intercept(4)
      ...
      assert result == 10
      assert intercepted_mfa == {AnnotatedInterceptedByWrapper3, :other_to_intercept, [4]}
    end
    ...
    test "it doesn't intercept the function that isn't configured" do
      ...
      Process.sleep(50)
      result = AnnotatedInterceptedByWrapper3.not_to_intercept()
  ...
  describe "other module with a single function" do
    test "it intercepts the function passing it as a lambda and changes the return value" do
      ...
      result = AnnotatedInterceptedByWrapper4.to_intercept()
      ...
      assert result != callback_result
      assert result == "Hello"
      assert intercepted_mfa == {AnnotatedInterceptedByWrapper4, :to_intercept, []}
    end
  end
